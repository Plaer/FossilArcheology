...
public class EntityRaptor extends EntityDinosaurce implements IHighIntellegent {
	...
	protected String getLivingSound() {
		...
		if (this.isTamed())
			return "fossilsarch:raptor_living_friendly";
		else
			return "fossilsarch:raptor_living_wild";
	}

	protected String getHurtSound() {
		return "fossilsarch:Raptor_hurt";
	...
	protected void attackEntity(Entity entity, float f) {
		...
		if (f > 2.0F && f < 5.0F && rand.nextInt(10) == 0) {
			if (onGround) {
				...
				worldObj.playSoundAtEntity(this, "fossilsarch:Raptor_attack",
