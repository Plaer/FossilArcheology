...
public class EntityStegosaurus extends EntityDinosaurce{
	...
	protected String getLivingSound()
    {
		...
		if (worldObj.getClosestPlayerToEntity(this, 8D)!=null) return "fossilsarch:Steg_living";
		else return null;
 
    }
	protected String getHurtSound()
    {
        return "fossilsarch:Steg_Hurt";
    }

    protected String getDeathSound()
    {
        return "fossilsarch:Steg_death";
    }
						...
						if (this.onGround){
							...
							if (((EntityPlayerSP)this.riddenByEntity).movementInput.sneak){
								...
								if(this.RushTick==0){
						            ...
						            for(; this.rotationYaw >= 180F; this.rotationYaw -= 360F) { }
									this.moveForward=((EntityPlayerSP) this.riddenByEntity).moveForward*8;
								}else{
									this.rotationYaw-=(float) ((float)(((EntityPlayerSP) this.riddenByEntity).moveStrafing)*5);
						            for(; this.rotationYaw < -180F; this.rotationYaw += 360F) { }
						            for(; this.rotationYaw >= 180F; this.rotationYaw -= 360F) { }
									this.moveForward=((EntityPlayerSP) this.riddenByEntity).moveForward*(3/4);
