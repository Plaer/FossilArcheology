...
import net.fossilsarch.common.ai.EntityAIBegSC;
...
public class EntitySaberCat extends EntityTameable
{
    ...
    {
    	return "fossilsarch:SaberCat_Living";
    }

    protected String getHurtSound()
    {
        return "fossilsarch:SaberCat_Hurt";
    }

    protected String getDeathSound()
    {
        return "fossilsarch:SaberCat_death";
    }
    ...
    protected void updateEntityActionState()
    {
        ...
        else if (entityToAttack == null && !hasPath() && !isTamed() && !isChild() && worldObj.rand.nextInt(100) == 0)
        {
            ...
            List list = worldObj.getEntitiesWithinAABB(EntityAnimal.class, AxisAlignedBB.getAABBPool().getAABB(posX, posY, posZ, posX + 1.0D, posY + 1.0D, posZ + 1.0D).expand(16D, 4D, 16D));
            if (!list.isEmpty())
            {
        ...
        {
            dataWatcher.updateObject(18, Integer.valueOf((int)getHealth()));
        }
    }
    ...
    @Override
    public EntityAgeable createChild(EntityAgeable par1EntityAnimal)
    {
