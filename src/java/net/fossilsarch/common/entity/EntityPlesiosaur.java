...
import net.fossilsarch.common.ai.DinoAIFishing;
...
public class EntityPlesiosaur extends EntityDinosaurce implements IWaterDino{
    ...
    {
		if (worldObj.getClosestPlayerToEntity(this, 8D)!=null) return "fossilsarch:Pls_Living";
		else return null;  
    }
	protected String getHurtSound()
    {
        return "fossilsarch:Pls_hurt";
    }
