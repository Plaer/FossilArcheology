...
import net.fossilsarch.client.model.ModelPterosaurFlying;
import net.fossilsarch.client.model.ModelStegosaurus;
...
public class RenderStegosaurus extends RenderLiving
{
	...
	public void renderCow(EntityStegosaurus entityStegosaurs, double d, double d1, double d2, 
            float f, float f1)
    {
		 //super.doRenderLiving(entityStegosaurs, d, d1, d2, f, f1);
		GL11.glPushMatrix();
       GL11.glDisable(2884 /*GL_CULL_FACE*/);
       this.bindTexture(this.getEntityTexture(entityStegosaurs));
       ...
       try
       {
           ...
           rotateCorpse(entityStegosaurs, f5, (entityStegosaurs.isModelized())?f3:f2, f1);
           float f6 = 0.0625F;
           ...
           float f7 = entityStegosaurs.prevLimbSwingAmount+ (entityStegosaurs.limbSwingAmount - entityStegosaurs.prevLimbSwingAmount) * f1;
           float f8 = entityStegosaurs.limbSwing - entityStegosaurs.limbSwingAmount * (1.0F - f1);
           if(f7 > 1.0F)
           {
               f7 = 1.0F;
           }
           ...
           mainModel.render(entityStegosaurs, f8, f7, f5, f3 - f2, f4, f6);
			/*if (entityStegosaurs.isSelfAngry() || entityStegosaurs.ItemInMouth!=null){
           ...
           for(int i = 0; i < 4; i++)
           {
               ...
               {
                   renderPassModel.render(entityStegosaurs,f8, f7, f5, f3 - f2, f4, f6);
