...
import net.fossilsarch.client.model.ModelPTSLanding;
import net.fossilsarch.client.model.ModelPterosaurFlying;
import net.fossilsarch.client.model.ModelPterosaurGround;
...
public class RenderPterosaur extends RenderLiving
{
            ...
            float f, float f1)
    {
        ...
        try
        {
            ...
            float f7 = entityPterosaur.prevLimbSwingAmount+ (entityPterosaur.limbSwingAmount - entityPterosaur.prevLimbSwingAmount) * f1;
            float f8 = entityPterosaur.limbSwing - entityPterosaur.limbSwingAmount * (1.0F - f1);
            if(f7 > 1.0F)
            {
                f7 = 1.0F;
            }
