...
public class RenderMammoth extends RenderLiving
{
    ...
    public void renderMammoth(EntityMammoth par1EntityMammoth, double par2, double par4, double par6, float par8, float par9)
    {
         ...
         try
         {
             ...
             float var15 = par1EntityMammoth.prevLimbSwingAmount+ (par1EntityMammoth.limbSwingAmount - par1EntityMammoth.prevLimbSwingAmount) * par9;
             float var16 = par1EntityMammoth.limbSwing - par1EntityMammoth.limbSwingAmount * (1.0F - par9);
