...
public class GuiWorktable extends GuiContainer
{
    ...
    {
        fontRenderer.drawString(StatCollector.translateToLocal("tile.worktableIdle.name"), 30, 6, 0x404040);
	...
	protected void drawGuiContainerBackgroundLayer(float f,int unusedi, int unusedj)
    {
        ...
        mc.renderEngine.bindTexture(new ResourceLocation("fossilsarch:gui/UIPazzle.png"));
        int j = (width - xSize) / 2;
