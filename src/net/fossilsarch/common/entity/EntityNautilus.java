				...
				if (!Extsit){
					...
					EntityLiving entityliving=null;
						if (new Random().nextInt(100)<GroupAmount){
							...
							if(	worldObj.checkNoEntityCollision(entityliving.boundingBox) && worldObj.getCollidingBoundingBoxes(entityliving, entityliving.boundingBox).size() == 0 && worldObj.isAnyLiquid(entityliving.boundingBox)) worldObj.spawnEntityInWorld(entityliving);
						}
				}
				this.BreedTick=3000;
			}
