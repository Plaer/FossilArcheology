...
import net.fossilsarch.common.block.BlockWorktable;
    ...
    implements IInventory
{
	...
	private int getItemBurnTime(ItemStack itemstack)
    {
        ...
        if (i==mod_Fossil.relic.itemID) return 300;
		else return 0;
    }
	...
	private ItemStack CheckSmelt(int index){
		...
		if (index==mod_Fossil.GenPickaxe.itemID) return new ItemStack(mod_Fossil.GenPickaxe);
		if (index==mod_Fossil.GenSword.itemID) return new ItemStack(mod_Fossil.GenSword);
		if (index==mod_Fossil.GenHoe.itemID) return new ItemStack(mod_Fossil.GenHoe);
		if (index==mod_Fossil.GenShovel.itemID) return new ItemStack(mod_Fossil.GenShovel);
		return null;
	}
	...
	public boolean isItemValidForSlot(int i, ItemStack itemstack) {
		if (i == 0 && CheckSmelt(itemstack.itemID) == null)
			...
			return false;
		else if (i == 1 && getItemBurnTime(itemstack) < 1)
			return false;
		else
			return true;
	}
