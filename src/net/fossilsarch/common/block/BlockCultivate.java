...
public class BlockCultivate extends BlockContainer 
{
    ...
    public Icon cultivate_top;
    public Icon cultivate_side_on;
    public Icon cultivate_side_off;
    
	public BlockCultivate(int i, boolean flag)
    {
	...
	public static void updateFurnaceBlockState(boolean flag, World world, int i, int j, int k)
    {
        ...
        if(flag)
        {
			world.setBlock(i, j, k, mod_Fossil.blockcultivateActive.blockID);
        } else
        {
			world.setBlock(i, j, k, mod_Fossil.blockcultivateIdle.blockID);
        }
